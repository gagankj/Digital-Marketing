...
const Pricing = () => {
    ...
    return (
        <div className="flex flex-col pt-32 items-center p-8">
            ...
            <div className={`flex space-x-8 mb-24 transition-opacity duration-1000 ${PricingVisible ? 'opacity-100' : 'opacity-0'}`}>
                {/* Tier 1: Starter */}
                ...
                {/* Tier 2: Growth */}
                <div className="bg-white rounded-lg border-2 border-orange-500 shadow-lg p-6 w-72">
