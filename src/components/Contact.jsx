...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-[#E9EFEC] flex flex-col items-center justify-center">
      <div>
        <h1 className={`text-7xl font-bold text-black mb-6 transition-opacity duration-1000 ${headingVisible ? 'opacity-100' : 'opacity-0'}`}>
